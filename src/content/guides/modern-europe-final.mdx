...
<Quiz
  ...
  questions={[
    ...
    { q: "Why is the Treaty of Versailles often called a cause of WWII, not just the end of WWI?", choices: [
    ...
    { q: "A historian says 1917 'was less a Bolshevik triumph than a Provisional Government collapse.' Which fact best supports that?", choices: [
    ...
    { q: "Appeasement (1938) and the Nazi-Soviet Pact (1939) are often linked. What is the strongest connection?", choices: [
    ...
    { q: "Which pairing correctly matches a Cold War doctrine with the event that best exemplifies it?", choices: [
    ...
    { q: "Stalin's USSR and Hitler's Germany were both totalitarian. Which contrast is historically accurate?", choices: [
