    ...
    children: [
      {
        ...
        children: [
          { name: "MAIN causes (Militarism + Alliances + Imperialism + Nationalism)" },
          { name: "Trench stalemate, ~20 million dead" },
          { name: "Russia exits early → Bolshevik Revolution" },
          { name: "US enters late → tips the balance" },
          { name: "Treaty of Versailles → German resentment" }
        ]
      },
      {
        name: "Russian Rev",
        children: [
          { name: "WWI breaks Tsar Nicholas II" },
          { name: "Bolsheviks promise Peace, Land, Bread" },
          { name: "Civil War (Reds vs Whites)" },
          { name: "Stalin replaces Lenin → Five-Year Plans + Great Purge" },
          { name: "Sets up the USSR that will be the Cold War rival" }
        ]
      },
      {
        name: "Interwar",
        children: [
          { name: "Weimar weakness + Versailles humiliation" },
          { name: "Hyperinflation 1923 + Great Depression 1929" },
          { name: "Mussolini + Hitler rise" },
          { name: "Appeasement encourages aggression" },
          { name: "Nazi-Soviet Pact 1939 clears path to war" }
        ]
      },
      {
        name: "WWII",
        children: [
          ...
          { name: "Stalingrad + Midway + D-Day = turning points" },
          { name: "Holocaust" },
          { name: "Atomic bombs end Pacific war" },
          { name: "US + USSR emerge as superpowers" }
        ]
      },
      {
        name: "Cold War",
        children: [
          ...
          { name: "Containment + Truman Doctrine + Marshall Plan + NATO" },
          { name: "Cuban Missile Crisis = brinkmanship peak" },
          { name: "Détente then Reagan pressure" },
          { name: "Gorbachev's reforms collapse the USSR" }
        ]
      }
    ]
