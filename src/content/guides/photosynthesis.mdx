...
import Globe3D from '../../components/Globe3D.astro';
...
<NivoSankey
  data={{
    ...
    links: [
      { source: 'Sunlight', target: 'Photosystem II', value: 100 },
      { source: 'Photosystem II', target: 'Photosystem I', value: 60 },
      { source: 'Photosystem II', target: 'ATP', value: 25 },
      { source: 'Photosystem II', target: 'Heat lost', value: 15 },
      { source: 'Photosystem I', target: 'NADPH', value: 50 },
      { source: 'Photosystem I', target: 'Heat lost', value: 10 },
...
<RechartsBar
  data={[
    { plant: 'C3 (wheat)', rate: 1.0 },
    { plant: 'C4 (corn)', rate: 1.6 },
    { plant: 'CAM (cactus)', rate: 0.4 }
  ]}
  xKey="plant"
  bars={[{ dataKey: 'rate', name: 'Relative rate (high temp, full sun)' }]}
/>
...
<DragMatch
  pairs={[
    { left: 'Photosystem II', right: 'Splits water and releases O₂' },
    { left: 'Photosystem I',  right: 'Re-energizes the electron with a second photon' },
    { left: 'ATP synthase',   right: 'Spins as H⁺ ions flow back across the thylakoid' },
    { left: 'RuBisCO',        right: 'Attaches CO₂ to RuBP in the Calvin cycle' },
    { left: 'NADPH',          right: 'Carries electrons from light reactions to Calvin cycle' }
  ]}
/>
...
<Globe3D
  title="Top photosynthetic regions"
  markers={[
    { lat: -3.4, lng: -62.2, label: 'Amazon rainforest', size: 0.8 },
    { lat: 0.0, lng: 25.0, label: 'Congo basin', size: 0.7 },
    { lat: -2.5, lng: 117.0, label: 'Indonesian rainforest', size: 0.7 },
    { lat: 0.0, lng: -30.0, label: 'Equatorial Atlantic phytoplankton', size: 0.6 },
    { lat: 0.0, lng: -160.0, label: 'Equatorial Pacific phytoplankton', size: 0.6 },
    { lat: 50.0, lng: -120.0, label: 'North American boreal forest', size: 0.5 },
    { lat: 60.0, lng: 90.0, label: 'Siberian taiga', size: 0.5 }
  ]}
/>
