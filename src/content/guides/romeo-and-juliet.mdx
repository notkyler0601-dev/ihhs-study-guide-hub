...
<Scrollytelling
  ...
  <div data-section='label' style='position: absolute; top: 16px; left: 24px; font-size: 10px; letter-spacing: 0.18em; text-transform: uppercase; color: rgba(250,250,249,0.45); font-family: Inter, sans-serif;'>Part 1, Romeo</div>
  ...
  <div class='bg-section' data-section='1' style='display: block; padding-top: 36px;'>
  ...
  <div class='bg-section' data-section='2' style='display: none; padding-top: 36px;'>
  ...
  <div class='bg-section' data-section='3' style='display: none; padding-top: 36px;'>
    <div style='font-size: 16px; line-height: 1.7;'>
  ...
  <div class='bg-section' data-section='4' style='display: none; padding-top: 36px;'>
  ...
  <div class='bg-section' data-section='5' style='display: none; padding-top: 36px;'>
    <div style='font-size: 14px; line-height: 1.6;'>
  ...
  onStep={`(stepId) => {
    ...
    stage.querySelectorAll('.bg-section').forEach((s) => {
      s.style.display = Number(s.getAttribute('data-section')) === t.section ? 'block' : 'none';
    });
