...
Hover over each labeled spot below to see what role that part of the building played, and which scenes used it.

<Hotspots
  title="The Elizabethan stage that hosted the original production"
  image="/globe-theatre.svg"
  alt="Cross-section of an Elizabethan playhouse, showing the thrust stage, tiring house, upper acting space, heavens canopy, galleries, and yard."
  mode="reveal"
  spots={[
    { x: 50, y: 22, label: "Flag", description: "A flag was raised above the playhouse on performance days. Color told Londoners the genre: black for tragedy (so a black flag would have flown for Romeo and Juliet)." },
    { x: 50, y: 38, label: "Lord's room", description: "Premium seating directly above the stage. The most expensive seats faced the back of the actors' heads, but it let aristocrats be seen by the rest of the audience." },
    { x: 50, y: 47, label: "Upper acting space", description: "Where Juliet appeared 'at the window.' The balcony scene was almost certainly staged here, with Romeo on the main stage below looking up." },
    { x: 30, y: 50, label: "Heavens canopy", description: "Painted with sun, moon, and stars on the underside. Gods and angels could be lowered through trapdoors in the heavens on ropes." },
    { x: 50, y: 75, label: "Trap door", description: "Opened in the stage floor for graves, ghosts, and underworld entrances. The tomb scene of Act 5 may have used this opening." },
    { x: 30, y: 80, label: "Yard (groundlings)", description: "Standing-room only, one penny. Up to 800 people packed in around the thrust stage, often heckling actors and snacking on hazelnuts." },
    { x: 12, y: 55, label: "Galleries", description: "Three covered tiers of seating around the perimeter, two pennies for a bench, three for a cushion." },
    { x: 50, y: 62, label: "Thrust stage", description: "The main acting platform jutting into the audience. The brawls, duels, and most dialogue happened here." },
    { x: 28, y: 55, label: "Pillars", description: "Two huge oak pillars (called Hercules and Atlas) held up the heavens. Actors used them to hide behind during sword-fight blocking." }
  ]}
/>
